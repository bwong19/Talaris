...
class InstructionViewController: UIViewController, GaitTestDelegate {
    ...
    override func viewDidLoad() {
        ...
        instructionText.isScrollEnabled = true
        instructionText.isUserInteractionEnabled = true
        ...
        instructionText.setContentOffset(topPoint, animated: false)
        instructionText.flashScrollIndicators()
        
        instructionText.layer.borderColor = UIColor.lightGray.cgColor;
        instructionText.layer.borderWidth = 1.0;
        instructionText.layer.cornerRadius = 5.0;
        
        view.addSubview(instructionText)
        
        instructionText.topAnchor.constraint(equalTo: view.topAnchor, constant: 72).isActive = true
        instructionText.bottomAnchor.constraint(equalTo: view.centerYAnchor, constant: 144).isActive = true
        ...
        instructionStackView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -8).isActive = true
