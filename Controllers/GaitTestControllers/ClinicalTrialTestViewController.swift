...
class ClinicalTrialTestViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        trialStackView.spacing = 10
        trialStackView.distribution = .fillEqually
        view.addSubview(trialStackView)
        trialStackView.topAnchor.constraint(equalTo: view.topAnchor, constant: 100).isActive = true
        trialStackView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -30).isActive = true
        trialStackView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 10).isActive = true
        trialStackView.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -10).isActive = true
        ...
        sixmwtButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 36)
        sixmwtButton.backgroundColor = UIColor(red:1.00, green:0.53, blue:0.26, alpha:1.0)
        sixmwtButton.layer.cornerRadius = 20
        ...
        tugButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 36)
        tugButton.backgroundColor = UIColor(red: 182/255, green: 223/255, blue: 1, alpha: 1)
        tugButton.layer.cornerRadius = 20
        ...
        mctsibButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 36)
        mctsibButton.backgroundColor = UIColor(red: 2/255, green: 87/255, blue: 122/255, alpha: 1)
        mctsibButton.layer.cornerRadius = 20
